...
- Click `Credentials`.
- Create an OAuth Client ID (under the Credentials tab), and add http://54.161.86.157.xip.io and 
http://ec2-54-161-86-157.compute-1.amazonaws.com/ as authorized JavaScript 
origins.
- Add http://54.161.86.157.xip.io/login,http://54.161.86.157.xip.io/gconnect,http://54.161.86.157.xip.io/callback
